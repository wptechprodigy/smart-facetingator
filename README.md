...
**Smart FaceTingator** is a face detector app. Hence the name Smart Face-Investigator.<br>
It detects the face in an uploaded file and tells you your rank in the number of users.

It relies on a face detecting API.
